...
def main(page: str, limit: int, data_dir: Path, folders: str, update:str): # download specific page, validate page & save each revision in a folder structure based on year & month
    """
...
if __name__ == "__main__": # only run if file is run directly, if imported file (eg. want to use a function) won't run
    ...
    parser.add_argument("--update", type=str, help="Decide whether to update files or not")
